    ...
    <div style={{ maxWidth: 680, margin: '0 auto', padding: '40px 20px', fontFamily: 'var(--font-body)' }}>
      ...
      <div style={{ lineHeight: 1.8, color: 'var(--text-secondary)', display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        <section>
          ...
          <p>All content on FEWS is for informational and educational purposes only. Always consult a SEBI-registered investment advisor before making any investment decisions.</p>
        </section>
        <section>
          <h2 style={{ fontSize: 18, fontWeight: 600, color: 'var(--text-primary)', marginBottom: 8 }}>Accuracy of Information</h2>
          <p>While we strive to present accurate summaries, FEWS cannot guarantee the accuracy, completeness, or timeliness of news summaries. Always verify information from original sources before acting on it.</p>
        </section>
        <section>
          <h2 style={{ fontSize: 18, fontWeight: 600, color: 'var(--text-primary)', marginBottom: 8 }}>Third-Party Content</h2>
          <p>News articles are sourced from third-party providers via licensed APIs. FEWS is not responsible for the content of external websites.</p>
        </section>
        <section>
